...
alphaFolder = 'F:\ImageFusion\code\RFN-Nest-S\rfn-A1\outputs\alpha_1e4_21\';

% Get lists of all image files in the folders
irFiles = dir(fullfile(ir_greyFolder, '*.jpg')); 
visFiles = dir(fullfile(vis_greyFolder, '*.jpg')); 
alphaFiles = dir(fullfile(alphaFolder, '*.jpg')); 
...
writetable(metricsTable, 'metricsResults.xlsx');